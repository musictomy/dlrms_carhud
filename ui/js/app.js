$(function () {
  window.addEventListener("message", function (event) {
    ...
    if (data.hazardLights == 1) {
      $(".left-signal").css("fill", "rgba(210, 172, 67, 1)");
      $(".left-signal").addClass("blink-anim");
    } else if (data.hazardLights == 2) {
      $(".right-signal").css("fill", "rgba(210, 172, 67, 1)");
      $(".right-signal").addClass("blink-anim");
    } else if (data.hazardLights == 3) {
      $(".left-signal").css("fill", "rgba(210, 172, 67, 1)");
      $(".left-signal").addClass("blink-anim");
      $(".right-signal").css("fill", "rgba(210, 172, 67, 1)");
      $(".right-signal").addClass("blink-anim");
